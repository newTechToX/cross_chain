...
def synapseMain():
    ...
    chains = ["ethereum", "polygon", "optimism", "arbitrum", "fantom", "avalanche", "bsc", "cronos", "boba",  "moonbeam", "klaytn", "dogechain", "harmony", "dfk", 
    "metis", "canto", "moonriver",]
    for chain in chains:
        session = Session()
